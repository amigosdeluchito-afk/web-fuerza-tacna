...
function injectGlobalAssets() {
    ...
    if (!document.getElementById('le-lab-dynamic-styles')) {
        ...
        style.innerHTML = `
            ...
            @media (max-width: 768px) { .candidate-card { width: 200px !important; height: 300px !important; border-radius: 1.2rem; } .candidate-info { padding: 1rem 0.5rem; } .candidate-info h3 { font-size: 1rem !important; margin-bottom: 0.2rem; } .candidate-info p { font-size: 0.7rem !important; } #candidatos-section { min-height: 85vh; padding-top: 10vh; } }
