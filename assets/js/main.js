...
function injectGlobalAssets() {
    ...
    const ensureGamesMenuItem = () => {
        ...
        menus.forEach((menu) => {
            menu.classList.add('has-games-menu');
            ...
            if (!link) {
                ...
                li.innerHTML = `<a href="${gamesHref}" data-menu-juegos="true"><span>JUEGA</span><span>CON LUCHITO</span></a>`;
                menu.appendChild(li);
                link = li.querySelector('a');
            } else {
                link.href = gamesHref;
                link.dataset.menuJuegos = 'true';
                link.innerHTML = '<span>JUEGA</span><span>CON LUCHITO</span>';
            }
        });
        bindGamesMenuLinks();
    };
    ...
    const injectChatIA = () => {
        ...
        if (document.getElementById('ft-chat-ia-script')) return;
            ...
            chatCSS.href = 'assets/universoobras/chat-ia.css?v=10'; // Avatar animado Luchito IA
            ...
            chatJS.src = 'assets/universoobras/chat-ia.js?v=12'; // Avatar animado Luchito IA
