window.LuchitoGames.registerGame('rock-paper-scissors', {
    ...
    render: function(container, level = 'medium') {
        ...
        if (!document.getElementById(styleId)) {
            ...
            style.id = styleId;
            style.innerHTML = `
                .lg-rps-game { display: flex; flex-direction: column; align-items: center; gap: 1rem; padding: 0.5rem; box-sizing: border-box; width: 100%; max-width: 600px; margin: 0 auto; }
                ...
                .lg-rps-header p { font-size: 0.95rem; margin: 0.2rem 0 0.5rem 0; opacity: 0.85; font-weight: bold; }
                ...
                .lg-rps-choices-new { display: flex; justify-content: center; gap: 1.2rem; width: 100%; margin: 0.5rem 0; }
                ...
                .lg-rps-card:hover:not(:disabled) { transform: translateY(-5px); box-shadow: 0 10px 20px rgba(128, 16, 57, 0.2); border-color: #ffc300; background: #fffdf5; }
                .lg-rps-card:active:not(:disabled) { transform: translateY(2px) scale(0.95); }
                .lg-rps-card.clicked { background: #ffc300; color: #801039; border-color: #801039; transform: scale(1.05); box-shadow: 0 10px 25px rgba(255, 195, 0, 0.4); }
                .lg-rps-card .emoji { font-size: 3rem; filter: drop-shadow(0 3px 3px rgba(0,0,0,0.15)); margin-bottom: -5px; }
                
                .lg-rps-result-display { min-height: 125px; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; width: 100%; }
                ...
                .final-result { font-family: 'Arial Black Web', sans-serif; font-size: 1.5rem; color: #801039; margin-top: 1rem; animation: fadeInZoom 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275) forwards; text-transform: uppercase; letter-spacing: 1px; }
                
                .lg-rps-actions-new { min-height: 50px; margin-top: 0.5rem; }
