...
window.rvApplyStyle = function() {
    ...
    if (toggles['parks']) style.layers.push({ id: "parks", type: "fill", source: "protomaps", "source-layer": "landuse", paint: { "fill-color": ["match", ["get", "class"], ["medical", "hospital"], t.amenity_med, ["education", "school", "university", "college"], t.amenity_edu, ["park", "pitch", "cemetery", "stadium", "wood", "grass", "forest"], t.parks, "rgba(0,0,0,0)"] } });
