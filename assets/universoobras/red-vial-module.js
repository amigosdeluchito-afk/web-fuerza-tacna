...
window.rvApplyStyle = function() {
    ...
    if (toggles['roads']) {
        style.layers.push({ id: "roads-casing", type: "line", source: "protomaps", "source-layer": "roads", paint: { "line-color": ["match", ["get", "pmap:kind"], "highway", t.road_main_case, "major_road", t.road_main_case, "medium_road", t.road_main_case, t.road_minor_case], "line-width": ["interpolate", ["linear"], ["zoom"], 12, ["match", ["get", "pmap:kind"], "highway", 4, "major_road", 4, "medium_road", 4, 1.5], 16, ["match", ["get", "pmap:kind"], "highway", 14, "major_road", 14, "medium_road", 14, 6]] } });
        style.layers.push({ id: "roads", type: "line", source: "protomaps", "source-layer": "roads", paint: { "line-color": ["match", ["get", "pmap:kind"], "highway", t.road_main, "major_road", t.road_main, "medium_road", t.road_main, t.road_minor], "line-width": ["interpolate", ["linear"], ["zoom"], 12, ["match", ["get", "pmap:kind"], "highway", 2.5, "major_road", 2.5, "medium_road", 2.5, 0.5], 16, ["match", ["get", "pmap:kind"], "highway", 10, "major_road", 10, "medium_road", 10, 4]] } });
    }
